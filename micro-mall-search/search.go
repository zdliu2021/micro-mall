...
import (
	...
	"mall-demo/micro-mall-search/middleware"
	proto_search "mall-demo/micro-mall-search/proto/micro-mall-search-proto"
	"mall-demo/micro-mall-search/server"
	"net"
	"strconv"
	"strings"
)
...
var (
	addrs = []string{"127.0.0.1:50041", "127.0.0.1:50042"}
)
...
func StartServer(addr string) {
	...
	proto_search.RegisterSearchRpcServer(grpcServer, new(server.Server))
...
func RegisterNacos(addr string) {
	...
	clientConfig := constant.ClientConfig{
		...
		LogDir:              "/Users/zongdianliu/go/src/mall-demo/micro-mall-search/log/",
		CacheDir:            "/Users/zongdianliu/go/src/mall-demo/micro-mall-search/log/",
		LogLevel:            "warn",
	}
	...
	global.GVA_LOG.Info("register search instance", zap.Any("ip", ip), zap.Any("port", port))
