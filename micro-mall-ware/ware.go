...
import (
	...
	"mall-demo/micro-mall-ware/middleware"
	proto_ware "mall-demo/micro-mall-ware/proto/micro-mall-ware-proto"
	"mall-demo/micro-mall-ware/server"
	"net"
	"time"
)

var (
	addrs = []string{"127.0.0.1:50021", "127.0.0.1:50022"}
)
...
func StartServer(addr string) {
	...
	// 2.注册服务
	proto_ware.RegisterWareRpcServer(grpcServer, new(server.Server))
...
//		LogDir:              "/Users/zongdianliu/go/src/mall-demo/micro-mall-ware/log",
//		CacheDir:            "/Users/zongdianliu/go/src/mall-demo/micro-mall-ware/log",
//		LogLevel:            "warn",
//	}
//
//	// 至少一个ServerConfig
