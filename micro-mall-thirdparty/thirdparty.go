...
import (
	...
	"mall-demo/micro-mall-thirdparty/middleware"
	proto_thirdparty "mall-demo/micro-mall-thirdparty/proto/micro-mall-thirdparty-proto"
	"mall-demo/micro-mall-thirdparty/server"
	"net"
	"time"
)

var (
	addrs = []string{"127.0.0.1:50011", "127.0.0.1:50012"}
)
...
func StartServer(addr string) {
	...
	proto_thirdparty.RegisterThirdPartyRpcServer(grpcServer, new(server.Server))
...
//		LogDir:              "/Users/zongdianliu/go/src/mall-demo/micro-mall-thirdparty/log/",
//		CacheDir:            "/Users/zongdianliu/go/src/mall-demo/micro-mall-thirdparty/log/",
//		LogLevel:            "warn",
//	}
//
//	// 至少一个ServerConfig
...
//
//	global.GVA_LOG.Info("reg thirdparty instance", zap.Any("ip", ip), zap.Any("port", port))
//
...
var srvName string = "mall-thirdparty"
