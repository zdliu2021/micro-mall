...
import (
	...
	"mall-demo/micro-mall-member/server"
	"net"
	"time"
)

var (
	addrs = []string{"127.0.0.1:50051", "127.0.0.1:50052"}
)
...
func StartServer(addr string) {
	...
	// 2.注册服务
	proto_member.RegisterMemberRpcServer(grpcServer, new(server.Server))
...
//		LogDir:              "/Users/zongdianliu/go/src/mall-demo/micro-mall-member/log",
//		CacheDir:            "/Users/zongdianliu/go/src/mall-demo/micro-mall-member/log",
//		LogLevel:            "warn",
//	}
//
//	// 至少一个ServerConfig
...
//
//	global.GVA_LOG.Info("reg member instance", zap.Any("ip", ip), zap.Any("port", port))
//
