...
import (
	...
	"mall-demo/micro-mall-auth-server/middleware"
	proto_auth_server "mall-demo/micro-mall-auth-server/proto/micro-mall-auth-server"
	"mall-demo/micro-mall-auth-server/server"
	"net"
	"time"
)

var (
	addrs = []string{"127.0.0.1:50181", "127.0.0.1:50182"}
)
...
func StartServer(addr string) {
	...
	// 2.注册服务
	proto_auth_server.RegisterAuthServerRpcServer(grpcServer, new(server.Server))
...
//		LogDir:              "/Users/zongdianliu/go/src/mall-demo/micro-mall-auth-server/log",
//		CacheDir:            "/Users/zongdianliu/go/src/mall-demo/micro-mall-auth-server/log",
//		LogLevel:            "warn",
//	}
//
//	// 至少一个ServerConfig
...
//
//	global.GVA_LOG.Info("reg ware instance", zap.Any("ip", ip), zap.Any("port", port))
//
