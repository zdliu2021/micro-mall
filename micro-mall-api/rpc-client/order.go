...
import (
	...
	"mall-demo/micro-mall-api/proto/micro-mall-order-proto"
	"math/rand"
	"strings"
...
var OrderClients []proto_order.OrderRpcClient

func GetOrderClient() proto_order.OrderRpcClient {
	return OrderClients[rand.Int()%len(OrderClients)]
}
...
//		LogDir:              "/Users/zongdianliu/go/src/mall-demo/micro-mall-api/log/api_order/",
//		CacheDir:            "/Users/zongdianliu/go/src/mall-demo/micro-mall-api/log/api_order/",
//		LogLevel:            "debug",
//	}
//
//	// 至少一个ServerConfig
...
//	})
//
//	OrderClients = make([]proto_order.OrderRpcClient, 0, len(instances))
//
...
//		}
//		c := proto_order.NewOrderRpcClient(grpcConn)
//		OrderClients = append(OrderClients, c)
//
//	}
//	global.GVA_LOG.Info(strconv.Itoa(len(OrderClients)))
//}
